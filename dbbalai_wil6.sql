...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 30, 2024 at 06:53 AM
...
--
CREATE DATABASE IF NOT EXISTS `dbbalai_wil6` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `dbbalai_wil6`;
...
CREATE TABLE `artikel` (
  ...
  `artikel_tags` varchar(500) NOT NULL,
  `artikel_foto` varchar(500) NOT NULL,
  `artikel_sbg_headline` enum('Y','N') NOT NULL DEFAULT 'Y',
  `artikel_tgl_posting` datetime NOT NULL,
  `artikel_id_user` bigint(20) NOT NULL,
  `artikel_tgl_last_edit` datetime NOT NULL,
  `artikel_editable` enum('Y','N') NOT NULL DEFAULT 'Y',
  `artikel_id_user_last_edit` int(11) NOT NULL,
  `artikel_seo_url` varchar(150) NOT NULL,
  `artikel_meta_description` varchar(160) NOT NULL,
  `artikel_meta_author` varchar(50) NOT NULL,
  `artikel_meta_keyword` varchar(500) NOT NULL,
  `artikel_og_image` varchar(500) NOT NULL,
  `artikel_og_title` varchar(100) NOT NULL,
  `artikel_og_description` varchar(250) NOT NULL,
  `artikel_in_draft` enum('Y','N') NOT NULL DEFAULT 'N',
  `artikel_aktif` enum('Y','N') NOT NULL DEFAULT 'Y',
  `artikel_terhapus` enum('Y','N') NOT NULL DEFAULT 'N',
  `artikel_status` enum('publish','draft','deleted') DEFAULT NULL,
  `artikel_was_published` enum('Y','N') NOT NULL DEFAULT 'N',
  `artikel_sesi_id` varchar(100) NOT NULL,
...
(53, 'http://localhost/apricot/an-component/media/upload-gambar-pendukung/WEB_BANNER_SELAMAT_DATANG_1.jpg', '', '', 'http://localhost/apricot/', 'http://localhost/apricot/'),
(54, 'http://localhost/apricot/an-component/media/upload-gambar-pendukung/WEB_BANNER_PAKAIAN_DINAS.jpg', '', '', '', ''),
(56, 'http://localhost/apricot/an-component/media/upload-gambar-pendukung/hari-raya-idul-fitri-1445h.png', '', ' ', '', '');
...
CREATE TABLE `banner_item` (
  ...
  `link_href` varchar(800) NOT NULL,
...
CREATE TABLE `download_temp` (
  `id` int(11) NOT NULL,
  `file` varchar(500) NOT NULL,
  `token_file` varchar(100) NOT NULL,
  `sesi_form` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `foto_artikel` (
  ...
  `token_foto` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `foto_artikel_temp` (
  `id_foto` bigint(20) UNSIGNED NOT NULL,
  `nama_foto` varchar(500) NOT NULL,
  `token_foto` varchar(500) NOT NULL,
  `sesi_form` varchar(100) NOT NULL,
...
CREATE TABLE `foto_galeri` (
  ...
  `nama_foto` varchar(600) NOT NULL,
  `token_foto` varchar(100) NOT NULL,
...
(5, 3, 'halal-bihalal-2024.jpg', '', ''),
(6, 3, 'kegiatan-halal-bihalal-2024.jpg', '0.6063052878402666', ''),
(7, 4, 'DSC04831.jpg', '', ''),
(8, 4, 'DSC04796.jpg', '', ''),
(9, 4, 'DSC04747.jpg', '', ''),
(10, 4, 'DSC04774.jpg', '', '');
...
CREATE TABLE `foto_user_tmp` (
  ...
  `token_foto` varchar(100) NOT NULL,
  `sesi_from` varchar(100) NOT NULL,
...
CREATE TABLE `galeri` (
  ...
  `galeri_nama` varchar(500) NOT NULL,
  `galeri_deskripsi` text NOT NULL,
  `galeri_feature_img` varchar(600) NOT NULL,
  `galeri_url` varchar(500) NOT NULL,
  `galeri_meta_keyword` varchar(600) NOT NULL,
  `galeri_meta_deskripsi` text NOT NULL,
  `galeri_og_image` varchar(300) NOT NULL,
  `galeri_og_deskripsi` varchar(600) NOT NULL,
  ...
  `galeri_status` enum('publish','draft') NOT NULL DEFAULT 'publish'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(3, 9, 'Halal Bihalal 2024', '<p>Dokumentasi Kegiatan Halal Bihalal 2024</p>', '', 'halal-bihalal-2024', '', '', '', '', '2024-04-17 16:25:47', '0000-00-00 00:00:00', 1, 1, 'publish'),
(4, 8, 'Capacity Bruiling & Profiling Trawas', '<p>Kegiatan Capacity Bruiling &amp; Profiling Trawas pada tanggal 11-13 Januari 2024</p>', '', 'capacity-bruiling-and-profiling-trawas', '', '', '', '', '2024-04-18 15:24:29', '0000-00-00 00:00:00', 1, 0, 'publish');
...
CREATE TABLE `informasi` (
  ...
  `webprivacy` text NOT NULL,
  `termcondition` text NOT NULL,
  `meta_keyword` varchar(600) NOT NULL,
  `meta_deskripsi` varchar(600) NOT NULL,
  `default_banner` varchar(500) NOT NULL,
  `featured_image` varchar(600) NOT NULL,
  `thumbnail_media` varchar(600) NOT NULL,
  `favicon` varchar(600) NOT NULL,
  `develope_mode` enum('Y','N') NOT NULL DEFAULT 'N',
  ...
  `prefix_suffix_title` varchar(500) NOT NULL,
  `prefix_suffix_sebagai` enum('prefix','suffix','none') NOT NULL DEFAULT 'prefix',
  ...
  `sleep_mode` enum('Y','N') NOT NULL DEFAULT 'N',
...
CREATE TABLE `kategori_galeri` (
  ...
  `slug_kategori` varchar(90) NOT NULL,
  `aktif` enum('Y','N') NOT NULL DEFAULT 'Y',
  `terhapus` enum('Y','N') NOT NULL DEFAULT 'N'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `kategori_produk` (
  ...
  `nama_kategori` varchar(100) NOT NULL,
  `slug_kategori` varchar(120) NOT NULL,
  `aktif` enum('Y','N') NOT NULL DEFAULT 'Y',
  `terhapus` enum('Y','N') NOT NULL DEFAULT 'N'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `media_sosial` (
  ...
  `social_icon` varchar(500) DEFAULT NULL,
...
CREATE TABLE `menu_child` (
  ...
  `menu_child_code` varchar(100) NOT NULL,
  `menu_child_nama` varchar(100) NOT NULL,
  `menu_child_url` varchar(500) NOT NULL,
  `menu_child_target` enum('_self','_blank','_parent','_top') NOT NULL DEFAULT '_self',
...
(87, 1, 17, '', 'Akreditasi dan Penghargaan', 'http://localhost/apricot/page/31-akreditasi-dan-penghargaan', '_self', 'Y', 9),
(88, 1, 77, '', 'Capaian Pelatihan', 'https://online.fliphtml5.com/byzax/qnmx/', '_blank', 'Y', 13),
...
(124, 1, 0, 'home', 'BUKU TAMU', 'https://forms.gle/FyRh7egXiEmwm84x6', '_blank', 'Y', 34);
...
CREATE TABLE `pages` (
  ...
  `page_judul` varchar(500) NOT NULL,
  `page_url` varchar(600) NOT NULL,
  `page_isi` text NOT NULL,
  `page_foto` varchar(600) NOT NULL,
  `page_javascript` text NOT NULL,
...
(2, 'Tugas dan Fungsi', 'tugas-dan-fungsi', '', 'http://localhost/apricot/an-component/media/upload-gambar-pendukung/tugas-fungsi.gif', '', 'published', 1, 1, '2024-04-26 08:22:37', '0000-00-00 00:00:00', 'tupoksi tugas pokok dan fungsi', 'tupoksi tugas pokok dan fungsi'),
...
(30, 'Saran dan Pengaduan', 'saran-dan-pengaduan', '<p>SILAHKAN KLIK LINK DI BAWAH INI<br><strong><a href=\"https://wa.me/6281252800027\" target=\"_blank\">WHATSAPP PENGADUAN BALAI 6</a></strong></p>', 'http://localhost/apricot/an-component/media/upload-gambar-pendukung/alur-aduan_1.gif', '', 'published', 14, 1, '2024-04-25 16:22:03', '0000-00-00 00:00:00', '', ''),
(31, 'Akreditasi dan Penghargaan', 'akreditasi-dan-penghargaan', '', 'http://localhost/apricot/an-component/media/upload-gambar-pendukung/ramadan-10926.gif', '', 'published', 1, 1, '2024-04-24 11:11:16', '0000-00-00 00:00:00', '', '');
...
CREATE TABLE `pencarian_artikel` (
  ...
  `clean_keyword` varchar(500) NOT NULL,
  `tanggal` datetime NOT NULL,
  `ip` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `pihak_ketiga` (
  `id` int(11) NOT NULL,
  `recaptcha_key` varchar(500) NOT NULL,
  `recaptcha_secret_key` varchar(500) NOT NULL,
  `script_google_analytics` varchar(500) NOT NULL,
  `disqus_unique_name` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `smtp_email` (
  ...
  `ssl_connection` enum('Y','N') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `user` (
  ...
  `password_user` varchar(190) NOT NULL,
...
(1, 'kamal', 'Kamal', '', '$2a$12$vzJDnmw3ZKozs7tKAfdpTOaHXap.ezZjXS6fxG8KKtVv/PmzkYSwi', 1, 'Melliani.jpg', 'Y', 'N', '0000-00-00'),
...
--
ALTER TABLE `foto_galeri`
  MODIFY `id_foto` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `foto_galeri_temp`
--
ALTER TABLE `foto_galeri_temp`
  MODIFY `id_foto` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `pages`
  MODIFY `page_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
-- Database: `db_school`
--
CREATE DATABASE IF NOT EXISTS `db_school` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `db_school`;
...
(1, '127.0.0.1', 'administrator', '$2y$12$63pqg8Mtq8ABN3c59RD2.OLMNLSV2hEij7bo1n59XNQFoM/xSz.iS', 'admin@mail.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1713834880, 1, 'Tegar', 'Pratama', NULL, '');
...
('root', '[{\"db\":\"dbbalai_wil6\",\"table\":\"artikel\"},{\"db\":\"dbbalai_wil6\",\"table\":\"menu_child\"},{\"db\":\"dbbalai_wil6\",\"table\":\"menu\"},{\"db\":\"dbbalai_wil6\",\"table\":\"pages\"},{\"db\":\"db_school\",\"table\":\"majors\"},{\"db\":\"dbbalai_wil6\",\"table\":\"faq\"},{\"db\":\"db_school\",\"table\":\"login_attempts\"},{\"db\":\"db_school\",\"table\":\"identity\"},{\"db\":\"db_school\",\"table\":\"groups\"},{\"db\":\"db_school\",\"table\":\"facilities\"}]');
...
('root', '2024-04-30 04:53:01', '{\"Console\\/Mode\":\"collapse\"}');
...
(10, '2024_04_01_022726_create_posts_table', 1);
...
(1, 'Judul Pertama', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam praesentiumaliquid dolorum voluptatum expedita nobis similique dolore impedit veniam, eaquecupiditate itaque autem culpa?', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam praesentiumaliquid dolorum voluptatum expedita nobis similique dolore impedit veniam, eaquecupiditate itaque autem culpa? Alias itaque, dolorem necessitatibus nobis quaerecusandae, nisi nam, reiciendis repudiandae nihil debitis delectus numquam. Ab,culpa praesentium! Magnam sequi vitae sed ut explicabo aspernatur ipsam, dolorumfacere nihil commodi totam officia, enim ducimus, quasi suscipit porro minima eaquidem dolores incidunt iste similique. Consequatur impedit reiciendis evenietfacere cupiditate excepturi nisi, dolorum nihil quis? Iure, ab accusamus? Atqueillo, magni perspiciatis, explicabo ipsam iusto excepturi iste facere, aliquidnihil doloremque? Quidem itaque eius voluptate aperiam?', NULL, '2024-03-31 19:41:41', '2024-03-31 19:41:41'),
(2, 'Judul Kedua', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur omnis earum hic cum esse culpa ea nisi nemo ipsam fugiat id, quaerat totam illum sit aspernatur sed explicabo consequuntur, voluptatem nihil delectus. Ullam dolor architecto neque quis natus.', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur omnis earum hic cum esse culpa ea nisi nemo ipsam fugiat id, quaerat totam illum sit aspernatur sed explicabo consequuntur, voluptatem nihil delectus. Ullam dolor architecto neque quis natus. Molestiae omnis tenetur quis deleniti aliquid aut vitae reprehenderit cumque quo vero, ipsam ex autem fugit, nulla repellat id laborum excepturi doloribus exercitationem amet temporibus suscipit! Fuga, neque. Suscipit repellat soluta perferendis optio dolor praesentium incidunt eius nihil dolore quasi, nemo magnam quis consequatur vero provident, id maiores iusto amet temporibus delectus, molestias neque minima voluptatibus? Quibusdam consectetur quis corrupti labore, nam quos atque! Totam consequuntur impedit dolor porro adipisci. Ipsa odit fuga voluptate nemo impedit! Fugiat delectus, quo voluptatum itaque perspiciatis vitae voluptas aperiam, eius, perferendis id minus at aspernatur nemo eligendi quos obcaecati magni exercitationem dicta quis. Ex, recusandae veniam voluptates ullam quidem quod? Autem deserunt est laborum nulla dicta.', NULL, '2024-03-31 19:44:32', '2024-03-31 19:44:32');
