...
define('USE_ACCESS_KEYS', true); // TRUE or FALSE  //edited
...
$config = array(
	...
	*/
	...
	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'], //edited
	...
	|
	*/
	'upload_dir' => '/'.$general['sub_dir'].'/an-component/media/upload-gambar-pendukung/', //edited
	...
	|
	*/
	'current_path' => '../../../../an-component/media/upload-gambar-pendukung/', //edited
	...
	|
	*/
	'thumbs_base_path' => '../../../../an-component/media/filemanager-thumbs/', //edited
	...
	*/
	...
	'access_keys' => array(isset($_SESSION["random_filemanager_key"])?$_SESSION["random_filemanager_key"]:md5(uniqid(rand(),true))), //edited
	...
	*/
	...
	'ext_file'                                => array(), //Files 'doc', 'docx', 'rtf', 'pdf', 'xls', 'xlsx', 'txt', 'csv', 'html', 'xhtml', 'psd', 'sql', 'log', 'fla', 'xml', 'ade', 'adp', 'mdb', 'accdb', 'ppt', 'pptx', 'odt', 'ots', 'ott', 'odb', 'odg', 'otp', 'otg', 'odf', 'ods', 'odp', 'css', 'ai' (edited)
	'ext_video'                               => array(), //Video 'mov', 'mpeg', 'm4v', 'mp4', 'avi', 'mpg', 'wma', "flv", "webm" edited
	'ext_music'                               => array(), //Audio 'mp3', 'm4a', 'ac3', 'aiff', 'mid', 'ogg', 'wav'  edited
	'ext_misc'                                => array(), //Archives   'zip', 'rar', 'gz', 'tar', 'iso', 'dmg'   edited

	/******************
	 * AVIARY config
	 *******************/
	'aviary_active'                           => false, //edited default false
	...
	'relative_path_from_current_pos'          => array( '','' ), //relative path of the image folder from the current position on upload folder (edited)
	...
	'relative_image_creation_height'          => array( 300, '' ), //height of image (you can leave empty if you set width) //FUCK THIS PART!!!!!!!!!!!! edited
	/*
	#             $option:     0 / exact = defined size;
	#                          1 / portrait = keep aspect set height;
	#                          2 / landscape = keep aspect set width;
