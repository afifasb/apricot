 ...
 <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo base_url() ?>" target="_blank" class="logo">
          ...
          <span class="logo-mini">BPSDM<span style='color:#00c0ef'><b>CMS</b></span></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg">BPSDM <span style='color:#00c0ef'><b>Content</b></span></span>
        </a>
...
<!-------------------------------------------------------------------------------------------------->
          ...
          <ul class="sidebar-menu">
           ...
           <?php if($user_level=='1'){    ?>
            ...
            <li class='<?php if($npage==35){ echo'active';} ?>'><a href='<?php echo $burl; ?>/media_sosial'><i class='fa fa-facebook'></i><span>Media Sosial</span></a></li>
             <li class='<?php if($npage==36){ echo'active';} ?>'><a href='<?php echo $burl; ?>/detail_balai'><i class='fa fa-info'></i><span>Detail Balai</span></a></li>
